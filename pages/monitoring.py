...
@callback(
    ...
    State("monitoring-bridge-selector", "value"),
)
def sync_monitoring_bridge_selector(store_data, current_value):
...
def on_monitoring_bridge_change(bridge_id, current_store, bridge_trigger, home_trigger):
    if not bridge_id:
